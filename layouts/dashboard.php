...
<head>
	...
	<meta name="author" content="Chintya Nayang">

	<title>PLN | Project10</title>
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/pln.jpeg" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/plln.jpeg" class="brand">
			<div class="user">
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023 -
			<?php echo date('Y'); ?>. Designed by Chintya Nayang
		</footer>
	</main>
